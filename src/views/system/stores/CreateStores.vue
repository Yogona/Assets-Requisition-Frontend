...
export default {
    ...
    methods: {
        ...
        async createStore() {
            if (this.$refs.createStoresForm.checkValidity()) {
                this.isLoading = true;
                ...
                await this.axios.post(this.api + "/stores/create", data).then((res) => {
    ...
    mounted() {
        this.notification.modal = this.Modal.getOrCreateInstance(
            document.getElementById("storeCreationNotification"), { backdrop: "static", keyboard: false }
        );
    }
}
</script>
...
<template>
    <div class="modal fade" id="storeCreationNotification" tabindex="-1" aria-labelledby="storeNotificationLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content container-bg">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="storeNotificationLabel">{{ notification.title }}</h1>
    ...
    <div class="card p-5 m-5">
        <form ref="createStoresForm" @submit.prevent="onSubmit">
            <div class="card-header">
                <h3 class="text-center card-title" id="createStoreLabel">CREATE STORES</h3>
            </div>
            <div class="card-body">
                <div class="mb-3">
            ...
            <div class="card-footer row">
                <button type="submit" @click="createStore()" class="btn btn-success">
                    <span :hidden="isLoading">Add store </span>
